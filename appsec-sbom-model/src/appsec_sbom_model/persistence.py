...
from .model import Version, Defect, VersionDefect
...
class Persistence:
    ...
    Args:
        ...
        username: The username for the FalkorDB database (optional).
    """
    ...
    def create_project_version(self, version: Version) -> None:
        ...
        logger.info(
            "Creating Version node for project=%s version=%s type=%s",
