...
Provides endpoints for uploading CycloneDX SBOM files and persisting
the parsed data (projects, dependencies, defects) to the graph database
via the sbom-graph-model library.
"""
