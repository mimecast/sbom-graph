...
from appsec_data_views.config import LDAPConfig
...
class TestAuthenticate:
    ...
    @patch("appsec_data_views.services.ldap_service.Connection")
    @patch("appsec_data_views.services.ldap_service.Server")
