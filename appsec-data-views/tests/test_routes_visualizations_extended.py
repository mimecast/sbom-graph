...
class TestDependenciesGraphRoute:
    ...
    def test_returns_html(self, client):
        with patch("appsec_data_views.routes.visualizations.create_dependencies_multi_layout_visualization") as m:
...
class TestDependantsMultiLayoutRoute:
    ...
    def test_returns_html(self, client):
        with patch("appsec_data_views.routes.visualizations.create_dependants_multi_layout_visualization") as m:
