...
from appsec_data_views.utils.validation import validate_defect_id
...
class TestXSSPrevention:
    ...
    def test_xss_in_project_name_rejected(self, client):
        with patch("appsec_data_views.routes.visualizations.create_kpartite_visualization"):
            response = client.get(
    ...
    def test_xss_in_css_dimension_sanitized(self, client):
        ...
        from appsec_data_views.utils.validation import validate_css_dimension
    ...
    def test_xss_in_format_parameter_sanitized(self, client):
        ...
        from appsec_data_views.utils.validation import validate_format
...
class TestOpenRedirectPrevention:
    ...
    def test_external_url_rejected(self):
        from appsec_data_views.utils.validation import is_safe_redirect_url
...
class TestPathTraversalPrevention:
    ...
    def test_dot_dot_in_project_name(self):
        from appsec_data_views.utils.validation import validate_project_name
    ...
    def test_null_byte_in_version(self):
        from appsec_data_views.utils.validation import validate_version_name
...
class TestAuthEnforcement:
    ...
    def test_protected_endpoint_returns_401_for_json(self, client):
        ...
        with patch("appsec_data_views.routes.reports.get_falkordb_service"):
            response = client.get(
                "/reports/projects",
                headers={"Accept": "application/json"},
            )
...
class TestInputValidationBoundaries:
    ...
    def test_max_depth_boundary_values(self):
        from appsec_data_views.utils.validation import validate_max_depth
    ...
    def test_limit_boundary_values(self):
        from appsec_data_views.utils.validation import validate_limit
    ...
    def test_boolean_validation_strict(self):
        from appsec_data_views.utils.validation import validate_boolean
