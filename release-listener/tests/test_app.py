...
from release_listener.app import (
...
class TestWebhookEndpoint:
    ...
    @patch('release_listener.app.process_release_scan')
    ...
    def test_process_failure_returns_500(self, mock_process, client, example_message):
        """Test that processing failures return 500 error."""
...
class TestProcessReleaseScan:
    ...
    @patch('release_listener.app.CycloneHelper')
    ...
    def test_returns_failure_on_not_found(self, mock_helper_class):
        ...
        assert 'SBOM not found' in result['error']
...
class TestIntegrationWithMockedSonatype:
    ...
    def test_multiple_webhook_messages_processed_sequentially(
        ...
        example_message['applicationEvaluation']['application']['id'] = 'second_app_id'
...
class TestFalkorDBIntegration:
    ...
    @patch('release_listener.app.SonaTypeClient.get_cyclonedx_sbom')
...
class TestCycloneHelper:
    ...
    @patch('release_listener.app.CycloneDXProcessor')
    @patch('release_listener.app.SonaTypeClient')
    @patch('release_listener.app.Persistence')
...
class TestEdgeCases:
    ...
    def test_case_insensitive_stage_matching(self, client, example_message):
        ...
        with patch('release_listener.app.process_release_scan') as mock_process:
            mock_process.return_value = {'success': True}
